 ...
 * @param  rocker_t 摇杆结构体
 */
void sixAixs_control(rockerInfo_t *rc,propellerPower_t *propeller)
{
    ...
    PropellerBuffer.leftDown   = propeller_Value*(rc->fx*propeller_Direction_Down_X  + rc->fy*propeller_Direction_Down_Y);
    PropellerBuffer.rightDown  = propeller_Value*(rc->fx*propeller_Direction_Down_X  + rc->fy*propeller_Direction_Down_Y);
    PropellerBuffer.leftUp     = propeller_Value*(rc->fx*propeller_Direction_Up_X    + rc->fy*propeller_Direction_Up_Y  );
